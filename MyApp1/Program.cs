...
namespace MyApp1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            emp1.Name = "エビ＝デンス";
            emp1.Sex = Sex.Man;
            emp1.Birthdate = DateTime.Parse("2016/03/01");
            ...
            emp2.Name = "ナン＝センス";
            emp2.Sex = Sex.Man;
            emp2.Birthdate = DateTime.Parse("2016/03/12");
            ...
            emp3.Name = "ヒヤ＝シンス";
            emp3.Sex = Sex.Women;
            emp3.Birthdate = DateTime.Parse("2000/05/01");
            ...
            string path = @"C:\Users\SYS-18\Desktop\makino\☆YM\[勉強会]\MyAppCreateFiles\Test.txt";
            if (!File.Exists(path))
            {
                //テキスト作成
            ...
            string path2 = @"C:\Users\SYS-18\Desktop";
